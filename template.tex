...
%In light of recent and upcoming growth in autonomous robotics, these problems must be overcome to make the smooth integration of robots into human society a reality. To that end, we examine what explorations have been made so far in this space, what possible solutions have been considered, and what fruitful avenues of future research are available.
...
%Whether autonomous cars driving among humans on the road or office robots traversing busy corridors, navigation through human environments will necessitate navigating the social topography of those spaces as well to minimize disruption. Even those applications without human interaction cannot escape a social dimension - after all, in Autofac, the automated factories escape human control and pose a threat to humanity, and anxieties surrounding the automation of labour extend the social impact of Amazon's warehouses far beyond its **walls[ref to MIT article about automation here].
...
%In his book **Vehicles, Braitenberg works through a progression of thought experiments on the nature of intelligent machines, each of his "vehicles" presenting more and more sophisticated behaviour until effectively replicating the conduct of an intelligent living being.
...
%TODO: Need more than just task allocation here?
...
%As such, research in navigation has been a part of robotics since at least Shaky**, and arguably a part of the popular conception of a robot since the Golem of antiquity. 
...
%Our desire to enhance robot utility by increasing their autonomy has encouraged us to explore how making robots more socially acceptable will ease their integration into society. Put simply, trying to create a socially autonomous robot without also creating a new social agent is attempting to have your cake and eat it too.
